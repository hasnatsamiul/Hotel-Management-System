...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">groupD@SUNRISE.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Dream <span>Touch</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Dream Touch</h3> 
						   <p class="about-para-w3ls">You will feel so comfortable in our resort.Its a five star resort.You will find everything what you need.</p>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/naimur.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/zhomo1.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/sami.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/moury1.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Naimur Rahman</h4>
							<span>Manager</span>
							<p> Hotel managers are responsible for managing employees and for planning, marketing , coordinating and administering hotel services such as catering and accommodation facilities.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>The work is usually performed in a waiting area such as a lobby or front office desk of an organization or business. The title receptionist is attributed to the person who is employed by an organization to receive or greet any visitors or clients and answer telephone calls.</p>	
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801750775308</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">groupD@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Savar, Dhaka</p>
...
<!-- /contact -->
			<div class="copy">
		        <p> Designed by <a href="index.php">Group D</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
